                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($data as $key => $val)
                                                                        ...
                                                                        <ul
                                                                            ...
                                                                            <li>
                                                                                <a href="#"
                                                                                    ...
                                                                                    data-bs-target="#updateData{{ $val->id }}">
                                                                                    <em
                                                                            ...
                                                                            <li>
                                                                                <a href="#"
                                                                                    data-bs-toggle="modal"
                                                                                    data-bs-target="#deleteData{{ $val->id }}"><em
                                                                                        class="icon ni ni-trash"></em><span>Delete</span></a>
                                                                            </li>
                                                                            <li>
                                                                                <a href="#"
                                                                                    data-bs-toggle="modal"
                                                                                    data-bs-target="#viewDetails{{ $val->id }}"><em
                                                    ...
                                                    <div class="modal fade modal-lg"
                                                        id="updateData{{ $val->id }}" data-bs-backdrop="static"
                                                        data-bs-keyboard="false" tabindex="-1"
                                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <form action="{{ route('admin.category.update', 1) }}"
                                                            method="POST" id="category_edit_form{{ $val->id }}"
                                                                ...
                                                                <div class="modal-content">
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <input
                                                                                                                    type="file"
                                                                                                                    id="category_image_update{{ $val->id }}"
                                                                                                                    name="image"
                                                                                                                    onchange="UpdateCategoryImage({{ $val->id }})"
                                                                                                                    style="display: none;">
                                                                                                                <em class="icon ni ni-camera-fill"
                                                                                                                    id="camera"
                                                                                                                    {{-- for="image" --}}
                                                                                                                    onclick="document.getElementById('category_image_update{{ $val->id }}').click()"
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <button type="submit"
                                                                            ...
                                                                            id="submit_edit{{ $val->id }}"
                                                                            onclick="EditDetails({{ $val->id }})"
                                                                            data-bs-target="#viewDetails{{ $val->id }}">Save
                                                                            Changes
                                                                        </button>
                                                                    </div>
                                                    ...
                                                    <div class="modal fade" id="deleteData{{ $val->id }}"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <a class="btn btn-danger"
                                                                        href="{{ url('admin/delete-category') }}/{{ $val->id }}">Yes</a>
                                                    ...
                                                    <div class="modal fade modal-lg"
                                                        id="viewDetails{{ $val->id }}" data-bs-backdrop="static"
                                                        data-bs-keyboard="false" tabindex="-1"
                                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="button"
                                                                        ...
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#updateData{{ $val->id }}">Edit</button>
                                                                    <button type="button"
                                                                        class="btn btn-sm btn-secondary"
                                                                        data-bs-dismiss="modal"
                                                                        onclick="CategoryPageRefresh({{ $val->id }})">Close</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
